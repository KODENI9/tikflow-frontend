        ...
        <div className="flex flex-col gap-8 h-full">
          <div className="flex items-center justify-between px-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold font-heading leading-none tracking-tight text-foreground">TikFlow</h1>
                <p className="text-tikflow-slate text-[10px] font-bold uppercase mt-1">Plateforme Fintech</p>
              </div>
            </div>
            <button onClick={onClose} className="md:hidden p-2 text-tikflow-slate hover:bg-foreground/5 rounded-lg">
              <X size={24} />
            </button>
          </div>
          ...
          <div className="mx-2 p-4 bg-tikflow-primary/5 rounded-2xl border border-tikflow-primary/10 flex flex-col gap-3">
            ...
            <p className="text-xs text-tikflow-slate font-medium leading-relaxed">Besoin d'aide pour une transaction ?</p>
            <div className="flex flex-col gap-2">
                {supportLinks.map((link, idx) => (
                    <a 
                      ...
                      className={`flex items-center gap-2 px-4 py-2 bg-background border border-glass-border rounded-xl text-xs font-black shadow-sm hover:bg-foreground/5 transition-colors ${link.color}`}
                    >
                      <link.icon size={14} />
                      {link.name}
                    </a>
          ...
          <div className="mt-auto border-t border-glass-border pt-4 flex items-center gap-3 px-2">
            ...
            <div className="flex-1 overflow-hidden">
              ...
              <div className="flex items-center gap-1.5">
                 <div className="size-1.5 bg-tikflow-accent rounded-full animate-pulse"></div>
                 <p className="text-[10px] text-tikflow-accent font-bold uppercase tracking-tighter">En ligne</p>
              </div>
            </div>
          </div>
        </div>
