...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  // On récupère le nom directement sans déclencher de boucle infinie
  const displayUserName = isLoaded ? (user?.firstName || user?.username || "Utilisateur") : "...";
        ...
        <div className="flex flex-col gap-8 h-full">
          ...
          <div className="mx-2 p-4 bg-blue-50/50 rounded-2xl border border-blue-100 flex flex-col gap-3">
            ...
            <a 
              ...
              className="px-4 py-2 bg-white text-[#1152d4] rounded-xl text-center text-xs font-black shadow-sm border border-blue-50 hover:bg-blue-50 transition-colors"
            >
              +228 90 51 32 79
            </a>
          </div>
